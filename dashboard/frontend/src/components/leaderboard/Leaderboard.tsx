                ...
                <Box data-testid="leaderboard"
                    ...
                    <Grid justifyContent={'center'} alignItems={'center'} width={'72%'}>
                        <Stack direction={'column'} width={'75%'}>
                            ...
                            <p style={{fontStyle: 'italic', marginTop: '-10px', marginBottom: '50px'}}>Ledertavlen viser
                                hvordan din enhet ligger ann i forhold til andre enheter basert på hvor stor andel av
