    ...
    <Card
      ...
      <Stack direction="column" sx={{ height: '100%' }}>
          ...
          <Tooltip
            title={
              <h2 style={{ fontSize: 15, fontWeight: 'lighter' }}>
                Diagrammet viser en oversikt over hvor mange aktive, ubrukte og
                ledige lisenser som eies i enheten.
              </h2>
            }
            placement="top"
            arrow>
        ...
        <Stack
          ...
          <Stack
            spacing={5}
            sx={{ paddingTop: 7.5, paddingLeft: 3, height: '100%' }}>
